...
values ((select user_id from users where email = 'ddooby.doobob@kakaoenterprise.com'), 1, now(), 'ddooby');

insert into user_authority (user_id, authority_id, created_at, created_by)
values ((select user_id from users where email = 'ddooby.doobob1@kakaoenterprise.com'), 2, now(), 'ddooby');

insert into follow (follower_id, followee_id, created_at, created_by)
values ((select user_id from users where email = 'ddooby.doobob1@kakaoenterprise.com'),
        (select user_id from users where email = 'ddooby.doobob@kakaoenterprise.com'),
        now(),
        'ddooby');